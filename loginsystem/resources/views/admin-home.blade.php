...
<div style="background-color: wheat;     margin-bottom: -25px;    margin-top: -24px; margin-right: 290px;        padding-bottom: 160px; " class="container">
                ...
                <div class="wrap-black">
                    <div class="wrap-black_btn">
                        <div style="  display:flex;    font-size: 18px;  background-color: white;      padding-bottom: 10px;   margin-left: -65px;    margin-top: 40px;      padding-left: 100px;     padding-right: 100px;    padding-top: 10px;    border-radius: 5px; " class="button-close" id="blog">
                            <a style="    color: black;     text-decoration: none;     margin-left: -50px;  " href="{{ url('create') }}">create</a>
                            <a style="     margin-left: 5px;   color: black;     text-decoration: none;  " href="{{ url('create') }}"> product</a>
                        </div>
                        <div style="  display:flex;    font-size: 18px;   margin-bottom: 300px;   background-color: white;     margin-left: -65px;    margin-top: 40px;      padding-left: 100px;     padding-right: 100px;    padding-top: 10px;    padding-bottom: 10px;border-radius: 5px; " class="button-close" id="user">
                            <a style="    color: black;     text-decoration: none;     margin-left: -50px;  " href="{{ url('index') }}">List  </a>
                            <a style="     margin-left: 5px;   color: black;     text-decoration: none;  " href="{{ url('index') }}">  products</a>
                        </div>
                    </div>
...
<div style="display: flex; "  class="row justify-content-center">
       ...
       text-decoration: underline;     font-style: italic;     " >Welcome to the  Admin  Dashboard</h3>
                    {{ __('Welcome, admin! You have logged in to the dashboard!') }}
                </div>
                </div> 
        </div>
    </div>
